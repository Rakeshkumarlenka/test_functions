...
#craete LIst of tuple where we can add diff details to the list only
bday_log = [
   ('Ayushi', ('1999', '10', '19')),
   ('Yash', ('1999', '04', '21')),
]
add = input('To add birthday type y:').strip().lower()   #string methods to remove white spaces
...
for birthday in bday_log:
   ...
   if current_date_lst[1] == birthday[1][1] and current_date_lst[2] == birthday[1][2]:
       ...
       print(f" It's {birthday[0]}'s {age}{ordinal_suffix} Birthday")   #dictonary
